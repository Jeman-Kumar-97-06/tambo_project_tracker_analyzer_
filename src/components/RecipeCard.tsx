...
export default function RecipeCard({
  ...
  return (
    <div className="bg-card max-w-md rounded-xl shadow-lg overflow-hidden border border-border">
      <div className="p-6">
        <div className="mb-4">
        ...
        <div className="mb-6 p-4 bg-muted rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-lg min-w-[3rem] text-center text-card-foreground">
                {servings}
              </span>
              <button
                onClick={() => handleServingsChange(servings + 1)}
