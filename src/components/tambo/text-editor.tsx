    ...
    const editor = useEditor({
      ...
      extensions: [
        ...
        Mention.configure({
          HTMLAttributes: {
            class:
              "mention resource inline-flex items-center rounded-md bg-muted px-2 py-0.5 text-xs font-medium text-muted-foreground border border-border",
          },
      ...
      editorProps: {
        attributes: {
          class: cn(
            ...
            "!text-foreground prose-neutral dark:prose-invert",
          ...
          style:
            "color: var(--foreground) !important; -webkit-text-fill-color: var(--foreground) !important;",
        },
