...
export function CanvasSpace({ className }: CanvasSpaceProps) {
  ...
  return (
    <div
      className={cn(
        "h-full w-full flex flex-col bg-background/50 backdrop-blur-sm overflow-hidden",
        className,
      )}
    ...
    >
      <div
        ...
        className="w-full flex-1 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-muted-foreground/30"
      >
